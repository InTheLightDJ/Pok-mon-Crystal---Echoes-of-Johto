...
class Pokemon
  ...
  # Hue rotation applied to this Pokémon's sprite (1-359). nil/0 = original colors.
  attr_accessor :recolor_hue
  # Desaturation amount (0 = full color, 255 = full grayscale). nil/0 = no change.
  attr_accessor :recolor_gray
