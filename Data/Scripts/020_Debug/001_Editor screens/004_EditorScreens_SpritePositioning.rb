...
class SpritePositioner
  def pbOpen
    ...
    @viewport.z = 99999
    battlebg   = "Graphics/Battlebacks/general_bg"
  ...
  def pbChangeSpecies(species, form)
    ...
    @sprites["pokemon_0"].setSpeciesBitmap(@species, 0, false, true, @form, false)
    @sprites["pokemon_1"].setSpeciesBitmap(@species, 0, false, false, @form)
