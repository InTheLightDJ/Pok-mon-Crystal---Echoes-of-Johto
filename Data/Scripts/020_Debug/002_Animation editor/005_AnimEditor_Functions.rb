module BattleAnimationEditor
  ...
  def animationEditorMain(animation)
    viewport = Viewport.new(0, 0, Settings::SCREEN_WIDTH + 480, Settings::SCREEN_HEIGHT + 384)
    viewport.z = 99999
    # Canvas
    ...
    sidewin.addSpace
    sidewin.addButton(_INTL("Play Anim"))
    ...
    animwin = CanvasAnimationWindow.new(canvas, 240, 384 + 128, 512 + 48, 96, canvas.viewport)
    # Name window
    bottomwindow = AnimationNameWindow.new(canvas, 240, 384 + 128 + 96, 512 + 48, 64, canvas.viewport)
    loop do
      Graphics.update
      Input.update
      sliderwin.update
...
def pbAnimationEditor
  ...
  Graphics.resize_screen(Settings::SCREEN_WIDTH + 480, Settings::SCREEN_HEIGHT + 384)
  pbSetResizeFactor(1)
