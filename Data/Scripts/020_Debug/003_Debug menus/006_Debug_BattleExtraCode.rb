...
#    PBEffects::ExtraType - set elsewhere
    ...
    # New effects
    PBEffects::AllySwitch     => { name: "Ally Switch applies this round",                default: false },
    PBEffects::CudChew        => { name: "Cud Chew number of rounds until active",        default: 0 },
    PBEffects::DoubleShock    => { name: "Double Shock has removed self's Electric type", default: false },
    PBEffects::GlaiveRush     => { name: "Glaive Rush vulnerability rounds remaining",    default: 0 },
    PBEffects::ParadoxStat    => { name: "Protosynthesis/Quark Drive stat boosted",       default: nil, type: :stat },
    PBEffects::BoosterEnergy  => { name: "Booster Energy applies",                        default: false },
    PBEffects::SaltCure       => { name: "Salt Cure applies",                             default: false },
    PBEffects::SilkTrap       => { name: "Silk Trap applies this round",                  default: false },
    PBEffects::Splinters      => { name: "Splinters number of rounds remaining",          default: 0 },
    PBEffects::SplintersType  => { name: "Splinters damage typing",                       default: nil, type: :type },
    PBEffects::SupremeOverlord => { name: "Supreme Overlord multiplier 1 + 0.1*x (0-5)",   default: 0, max: 5 },
    PBEffects::Syrupy         => { name: "Syrupy turns remaining",                        default: 0 },
    PBEffects::SyrupyUser     => { name: "Battler syruped self",                          default: -1 },
