...
MenuHandlers.add(:debug_menu, :field_menu, {
  ...
  "parent"      => :main,
  "description" => _INTL("In field debug actions."),
  "always_show" => false
})
...
MenuHandlers.add(:debug_menu, :warp, {
  ...
  "parent"      => :field_menu,
  "description" => _INTL("Warp to another map of your choice."),
...
MenuHandlers.add(:debug_menu, :use_pc, {
  "name"        => _INTL("Use PC"),
  "parent"      => :field_menu,
  "description" => _INTL("Access the PC (κΜ storage and player's)."),
  "effect"      => proc {
    pbPokeCenterPC
  }
})
...
MenuHandlers.add(:debug_menu, :switches, {
  "name"        => _INTL("Switches"),
  "parent"      => :field_menu,
  "description" => _INTL("Edit all Game Switches (except scripts)."),
  "effect"      => proc {
    pbDebugVariables(0)
  }
})
...
MenuHandlers.add(:debug_menu, :variables, {
  ...
  "parent"      => :field_menu,
  "description" => _INTL("Edit all Game Variables."),
  "effect"      => proc {
    pbDebugVariables(1)
  }
})
...
MenuHandlers.add(:debug_menu, :safari_zone_and_bug_contest, {
  "name"        => _INTL("Contest games"),
  "parent"      => :field_menu,
  "description" => _INTL("Edit Safari Zone and Bug-Catching contest."),
  "effect"      => proc {
    if pbInSafari?
...
MenuHandlers.add(:debug_menu, :edit_field_effects, {
  ...
  "parent"      => :field_menu,
  "description" => _INTL("Edit current field effects."),
  "effect"      => proc {
    cmd = 0
    loop do
      cmds = []
...
MenuHandlers.add(:debug_menu, :refresh_map, {
  ...
  "parent"      => :field_menu,
  "description" => _INTL("Refresh all events on a map."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :day_care, {
  "name"        => _INTL("Day Care"),
  "parent"      => :field_menu,
  "description" => _INTL("View κΜ in the Day Care and edit them."),
  "effect"      => proc {
    pbDebugDayCare
  }
})
...
MenuHandlers.add(:debug_menu, :storage_wallpapers, {
  ...
  "parent"      => :field_menu,
  "description" => _INTL("Manage wallpapers used in κΜ storage."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :skip_credits, {
  ...
  "parent"      => :field_menu,
  "description" => _INTL("Credits can be ended pressing Use input."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :battle_menu, {
  ...
  "parent"      => :main,
  "description" => _INTL("Battle debug actions."),
  "always_show" => false
})
...
MenuHandlers.add(:debug_menu, :test_wild_battle, {
  ...
  "parent"      => :battle_menu,
  "description" => _INTL("Start a single battle against a wild κΜ."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :test_wild_battle_advanced, {
  ...
  "parent"      => :battle_menu,
  "description" => _INTL("Start a battle against 1 or more wild κΜ."),
  "effect"      => proc {
    pkmn = []
    size0 = 1
    pkmnCmd = 0
...
MenuHandlers.add(:debug_menu, :test_trainer_battle, {
  ...
  "parent"      => :battle_menu,
  "description" => _INTL("Start a single battle against a trainer."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :test_trainer_battle_advanced, {
  ...
  "parent"      => :battle_menu,
  "description" => _INTL("Start a battle against 1 or more trainers."),
  "effect"      => proc {
    trainers = []
    size0 = 1
    size1 = 1
...
MenuHandlers.add(:debug_menu, :encounter_version, {
  ...
  "parent"      => :battle_menu,
  "description" => _INTL("Choose which wild encounters ver. use."),
  "effect"      => proc {
    params = ChooseNumberParams.new
...
MenuHandlers.add(:debug_menu, :roamers, {
  ...
  "parent"      => :battle_menu,
  "description" => _INTL("Toggle and edit all roaming κΜ."),
  "effect"      => proc {
    pbDebugRoamers
  }
})
...
MenuHandlers.add(:debug_menu, :reset_trainers, {
  ...
  "parent"      => :battle_menu,
  "description" => _INTL("Reset events with \"Trainer\" as name."),
  "effect"      => proc {
    if $game_map
...
MenuHandlers.add(:debug_menu, :toggle_exp_all, {
  "name"        => _INTL("Toggle Exp. All"),
  "parent"      => :battle_menu,
  "description" => _INTL("Toggle Exp. All's effect."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :toggle_logging, {
  ...
  "parent"      => :battle_menu,
  "description" => _INTL("Record debug logs for battles."),
  "effect"      => proc {
    $INTERNAL = !$INTERNAL
...
MenuHandlers.add(:debug_menu, :pokemon_menu, {
  ...
  "parent"      => :main,
  "description" => _INTL("Pokémon-related debug actions."),
  "always_show" => false
})
...
MenuHandlers.add(:debug_menu, :heal_party, {
  ...
  "parent"      => :pokemon_menu,
  "description" => _INTL("Fully heal all κΜ in the party."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :add_pokemon, {
  ...
  "parent"      => :pokemon_menu,
  "description" => _INTL("Give yourself a customized κΜ."),
  "effect"      => proc {
    species = pbChooseSpeciesList
    if species
      params = ChooseNumberParams.new
...
MenuHandlers.add(:debug_menu, :fill_boxes, {
  ...
  "parent"      => :pokemon_menu,
  "description" => _INTL("Fill the Pokémon storage."),
  "effect"      => proc {
    added = 0
...
MenuHandlers.add(:debug_menu, :quick_hatch_party_eggs, {
  ...
  "parent"      => :pokemon_menu,
  "description" => _INTL("All party Eggs hatch in one step."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :open_storage, {
  "name"        => _INTL("Access κΜ storage"),
  "parent"      => :pokemon_menu,
  "description" => _INTL("Access Organize Boxes mode."),
  "effect"      => proc {
    pbFadeOutIn do
...
MenuHandlers.add(:debug_menu, :toggle_snag_machine, {
  ...
  "description" => _INTL("Toggle all balls can catch Shadow κΜ."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :toggle_purify_chamber_access, {
  ...
  "parent"      => :shadow_pokemon_menu,
  "description" => _INTL("Access purification from the PC or not."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :purify_chamber, {
  ...
  "parent"      => :shadow_pokemon_menu,
  "description" => _INTL("Open it to purify Shadow κΜ."),
  "effect"      => proc {
    pbPurifyChamber
  }
})
...
MenuHandlers.add(:debug_menu, :relic_stone, {
  ...
  "parent"      => :shadow_pokemon_menu,
  "description" => _INTL("Use the Relic Stone for Shadow κΜ."),
  "effect"      => proc {
    pbRelicStone
  }
})
...
MenuHandlers.add(:debug_menu, :add_item, {
  "name"        => _INTL("Add item"),
  "parent"      => :items_menu,
  "description" => _INTL("Add an item to the Bag (choose quantity)."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :fill_bag, {
  "name"        => _INTL("Fill Bag"),
  "parent"      => :items_menu,
  "description" => _INTL("Add all items to the Bag (choose quantity)."),
  "effect"      => proc {
    params = ChooseNumberParams.new
    params.setRange(1, Settings::BAG_MAX_PER_SLOT)
    params.setInitialValue(1)
...
MenuHandlers.add(:debug_menu, :player_menu, {
  ...
  "parent"      => :main,
  "description" => _INTL("Player-related debug actions."),
  "always_show" => false
})
...
MenuHandlers.add(:debug_menu, :set_money, {
  ...
  "parent"      => :player_menu,
  "description" => _INTL("Edit how much money/coins you have."),
  "effect"      => proc {
    cmd = 0
    loop do
...
MenuHandlers.add(:debug_menu, :toggle_pokedex, {
  "name"        => _INTL("Toggle ΡΚdex/Reg. Dexes"),
  "parent"      => :player_menu,
  "description" => _INTL("Toggle Pokédex and Dexes access."),
  "effect"      => proc {
    dexescmd = 0
    loop do
      dexescmds = []
...
MenuHandlers.add(:debug_menu, :edit_phone_contacts, {
  ...
  "parent"      => :player_menu,
  "description" => _INTL("Edit properties of phone and reg. contacts."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :toggle_box_link, {
  "name"        => _INTL("Toggle access to storage from party"),
  "parent"      => :player_menu,
  "description" => _INTL("Box Link's effect via party screen."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :set_player_character, {
  ...
  "parent"      => :player_menu,
  "description" => _INTL("Edit the player's character."),
  "effect"      => proc {
    index = 0
    cmds = []
    ids = []
...
MenuHandlers.add(:debug_menu, :set_map_connections, {
  ...
  "description" => _INTL("Connect maps using a visual interface."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :set_encounters, {
  ...
  "parent"      => :pbs_editors_menu,
  "description" => _INTL("Edit wild κΜ from maps."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :set_trainers, {
  ...
  "parent"      => :pbs_editors_menu,
  "description" => _INTL("Edit individual trainers, their κΜ and items."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :set_metadata, {
  ...
  "parent"      => :pbs_editors_menu,
  "description" => _INTL("Edit global and player metadata."),
  "effect"      => proc {
    pbMetadataScreen
  }
})
...
MenuHandlers.add(:debug_menu, :set_species, {
  ...
  "parent"      => :pbs_editors_menu,
  "description" => _INTL("Edit κΜ species data."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :position_sprites, {
  ...
  "parent"      => :pbs_editors_menu,
  "description" => _INTL("Reposition κΜ sprites in battle."),
  "effect"      => proc {
    pbFadeOutIn do
...
MenuHandlers.add(:debug_menu, :auto_position_sprites, {
  ...
  "parent"      => :pbs_editors_menu,
  "description" => _INTL("Auto-position κΜ sprites in battle."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :set_pokedex_lists, {
  ...
  "parent"      => :pbs_editors_menu,
  "description" => _INTL("Manage the regional dexes of your game."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :editors_menu, {
  ...
  "parent"      => :main,
  "description" => _INTL("Non-information debug actions.")
})
...
MenuHandlers.add(:debug_menu, :import_animations, {
  ...
  "parent"      => :editors_menu,
  "description" => _INTL("Import \"Animations\" folder."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :export_animations, {
  ...
  "parent"      => :editors_menu,
  "description" => _INTL("Export to the \"Animations\" folder."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :set_terrain_tags, {
  ...
  "parent"      => :editors_menu,
  "description" => _INTL("Edit the terrain tags of tiles in tilesets."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :fix_invalid_tiles, {
  ...
  "parent"      => :editors_menu,
  "description" => _INTL("Erases non-existent tiles in maps."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :files_menu, {
  ...
  "parent"      => :main,
  "description" => _INTL("Files-related debug actions.")
})
...
MenuHandlers.add(:debug_menu, :rename_files, {
  ...
  "parent"      => :files_menu,
  "description" => _INTL("Update outdated file names."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :extract_text, {
  "name"        => _INTL("Extract text (translate)"),
  "parent"      => :files_menu,
  "description" => _INTL("Extract all text ingame to text files."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :compile_text, {
  ...
  "parent"      => :files_menu,
  "description" => _INTL("Import extracted text files."),
  "effect"      => proc {
...
MenuHandlers.add(:debug_menu, :reload_system_cache, {
  ...
  "parent"      => :files_menu,
  "description" => _INTL("Use it when edit a file while playing."),
  "effect"      => proc {
    System.reload_cache
    pbMessage(_INTL("Done."))
  }
