...
class PokemonGlobalMetadata
  ...
  attr_accessor :mirrorherb_steps # Mirror Herb step counter.
  ...
  # Battle Wager Arena
attr_accessor :last_wager_day
attr_accessor :daily_wager_matches
attr_accessor :wager_match_theme
