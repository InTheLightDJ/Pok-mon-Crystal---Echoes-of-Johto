#===============================================================================
# Unreal Time System - credits to FL
#
# It makes the time in game uses its own clock that only pass when you are in
# game instead of using real time.
#===============================================================================
#
# HOW TO USE:
#
...
module UnrealTime
  ...
  def self.initial_date
    return Time.local(2000, 12, 14, 10, 0)
  end
  ...
  class << self
    if method_defined?(:getTone) && UnrealTime::TONE_CHECK_INTERVAL > 0
      def getTone
        ...
        Graphics.frame_count - @dayNightToneLastUpdate >= Graphics.frame_rate * UnrealTime::TONE_CHECK_INTERVAL
        )
