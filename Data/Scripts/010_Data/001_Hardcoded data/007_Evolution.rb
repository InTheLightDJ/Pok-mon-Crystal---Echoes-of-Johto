...
# Contest-condition evolutions.
# Triggered by pbStartContest passing the contest category as the event value.
# Condition: pkmn's relevant stat >= parameter AND the category matches.
GameData::Evolution.register({
  :id         => :Beauty,
  :parameter  => Integer,
  :event_proc => proc { |pkmn, parameter, value|
    next pkmn.beauty >= parameter && value == :BEAUTY
  }
})
...
GameData::Evolution.register({
  ...
  :parameter  => Integer,
  :event_proc => proc { |pkmn, parameter, value|
    next pkmn.cool >= parameter && value == :COOL
  }
})
...
GameData::Evolution.register({
  ...
  :parameter  => Integer,
  :event_proc => proc { |pkmn, parameter, value|
    next pkmn.cute >= parameter && value == :CUTE
  }
})
...
GameData::Evolution.register({
  ...
  :parameter  => Integer,
  :event_proc => proc { |pkmn, parameter, value|
    next pkmn.smart >= parameter && value == :SMART
  }
})
...
GameData::Evolution.register({
  ...
  :parameter  => Integer,
  :event_proc => proc { |pkmn, parameter, value|
    next pkmn.tough >= parameter && value == :TOUGH
  }
})
...
#===============================================================================
# Special evolution methods (Gen 9)
#===============================================================================
GameData::Evolution.register({
  :id            => :CollectItems,
  :parameter     => :Item,
