class Sprite_SurfBase
  ...
  def initialize(parent_sprite, viewport = nil)
    ...
    @viewport = viewport
    @disposed = false
    @surfbitmap = AnimatedBitmap.new("Graphics/Characters/base_surf&dive")
    @divebitmap = AnimatedBitmap.new("Graphics/Characters/base_surf&dive")
    RPG::Cache.retain("Graphics/Characters/base_surf&dive")
    RPG::Cache.retain("Graphics/Characters/base_surf&dive")
