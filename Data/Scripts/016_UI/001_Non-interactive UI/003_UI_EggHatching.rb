...
#                         Tweaked by Maruno
#                         Tweaked for Pkmn Essentials GBC by Caruban and Xave
#===============================================================================
...
# Graphics/Pokemon/Eggs/eggCracks.
#===============================================================================
class PokemonEggHatch_Scene
  def pbStartScene(pokemon)
    ...
    @sprites["pokemon"].setSpeciesBitmap(@pokemon.species, @pokemon.gender,
                                         @pokemon.shiny?, false, @pokemon.form,
                                         false, true)   # Egg sprite
    ...
    # Load Flashes bitmap
    crack_effect_filename = sprintf("Graphics/Pokemon/Eggs/crack_effect") rescue nil
    crack_effect_filename = pbResolveBitmap(crack_effect_filename)
    @flashSheet = AnimatedBitmap.new(crack_effect_filename)
    # Create egg flash sprite
    @sprites["flash"] = Sprite.new(@viewport)
    @sprites["flash"].x = 0
    @sprites["flash"].y = 0
...
def pbHatch(pokemon)
  ...
  pbGiveAchievement(5) if $stats.eggs_hatched == 100
