...
class PokemonTrade_Scene
  ...
  def pbScene1
    ...
    picturePoke.moveColor(2, 5, Color.new(248, 176, 240, 248))
    # Recall
  ...
  def pbScene2
    ...
    picturePoke.setColor(0, Color.new(248, 176, 240, 248))
...
# Trade-back helper: pick a non-egg mon, trade it out and immediately back.
# switch_id (default 1): turned ON during the tradeback and OFF when done.
# npc_name (optional): name shown in the trade scene.
