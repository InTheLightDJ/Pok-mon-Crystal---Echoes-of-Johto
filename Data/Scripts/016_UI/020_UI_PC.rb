...
MenuHandlers.add(:pc_menu, :pokemon_storage, {
  ...
  "order"     => 10,
  "effect"    => proc { |menu|
    pbMessage("\\se[PC access]" + _INTL("Pokémon Storage System opened."))
    command = 0
    loop do
      command = pbShowCommandsWithHelp(nil,
                                       [_INTL("Organize Boxes"),
                                        ...
                                        _INTL("Buy Box"),
                                        _INTL("See ya!")],
                                       [_INTL("Organize the κΜ in Boxes/party."),
                                        _INTL("Move κΜ stored in Boxes to your party."),
                                        _INTL("Store κΜ in your party in Boxes."),
                                        _INTL("Buy another Box with Server Tokens."),
...
MenuHandlers.add(:pc_menu, :wonder_trade, {
  "name"      => _INTL("Wonder Trade"),
  "order"     => 25,
  "effect"    => proc { |menu|
    NetworkWonderTrade.start
    next false
  }
})
