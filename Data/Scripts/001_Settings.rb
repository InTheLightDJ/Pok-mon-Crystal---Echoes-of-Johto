#==============================================================================#
#                            Pokémon Essentials GBC                            #
#                                 Version 1.0                                  #
#                https://github.com/Xave-dev/pokemon-essentials-gbc            #
#                                                                              #
#                    Created using: Pokémon Essentials v21.1                   #
...
module Settings
  ...
  # If you want the full Gen 9 experience, take into consideration these updated
  # effects:
  #============================================================================
  ...
  def self.game_credits
    return [
      ...
      "STAFF",
      "",
      _INTL("Echo's Of Johto By:"),
      "InTheLight",
      "",
      _INTL("ESSENTIALS GSC KIT BY: "),
      "Maruno",
      "Xave",
      "InTheLight",
      "Rique",
      ...
      "Maruno",
      "",
      _INTL("Charecter Sprites"),
      "Most of the Player sprites were done by Bani",
       "( @Bani )",
      "",
      ...
      "Triple Triad Booster Pack - by FL",
      "Wizz Light - Lots Of Maps",
      "MegamanOmega and Shockslayer - Follower sprites",
      "LightTheInn, InTheLight - Music - YouTube",
      "derFischae - over world encounters",
      "",
      _INTL("GAME TESTERS:"),
      "InTheLight - I like putting my name in credits",
      "PlipTheFoxDad - Watch his streams on Twitch",
      "JCRogue - Also streams on twitch",
      "And anyone I missed",
      "",
      _INTL("AND YOU THE PLAYER!"),
      "Thank you for playing!",
      "",
      "",
      "",
       _INTL("POKEMON IS OWNED BY:"),
      "The Pokémon Company",
      "NINTENDO",
      "GAME FREAK",
      "",
      "THIS IS A NON PROFIT FAN GAME",
  ...
  # Credits format: GS (true) or Crystal (false)
  GS_STYLE_CREDIT = false
  ...
  MAX_COINS            = 99_999
  # The maximum number of Bug tokens the player can have.
  MAX_Bug_Tokens       = 99_999
  ...
  # Overworld
  #-----------------------------------------------------------------------------
  # Overworld/Instant encounter mix (0..100)
  INSTANT_BATTLE_PROB_DEFAULT = 1   # 0 = only overworld spawns 200 = no
  # Whether outdoor maps should be shaded according to the time of day.
  TIME_SHADING               = false
  # Whether the reflections of the player/events will ripple horizontally.
  ANIMATE_REFLECTIONS        = true
  # Whether use custom berry graphics (true) or GBC games default ones (false).
  CUSTOM_BERRY_GRAPHICS      = false
  ...
  # Whether Performance Contests play Pokémon slide-in / attack animations.
  # Disable for faster contests or lower-end hardware.
  CONTEST_ANIMATIONS         = true
  ...
  MOVE_RELEARNER_CAN_TEACH_MORE_MOVES = true #(MECHANICS_GENERATION >= 6)
  ...
  BREEDING_CAN_INHERIT_MACHINE_MOVES         = true #(MECHANICS_GENERATION <= 5)
  # Whether a bred baby Pokémon can inherit egg moves from its mother. It can
  # always inherit egg moves from its father.
  BREEDING_CAN_INHERIT_EGG_MOVES_FROM_MOTHER = true #(MECHANICS_GENERATION >= 6)
  ...
  #     ROAMING_AREAS).
  # Whether to play "Fate Of The S.S.Anne" when the player is on the same map
  # as a roaming Pokémon (Entei/Raikou). Reverts to normal BGM on map exit.
  ROAMER_MUSIC = true
  ...
  ROAMING_SPECIES = [
    ...
    [:ENTEI,   40, 55, 1, "vs Roaming Pokemon"],
    [:RAIKOU,  40, 55, 1, "vs Roaming Pokemon"],
    [:SUICUNE, 40, 94, 1, "vs Roaming Pokemon"],
    [:MEW, 1, 56, 3, "vs Roaming Pokemon"],
    [:CELEBI, 40, 72, 1, "vs Roaming Pokemon"]
  ]
  ...
  # The maximum number of boxes storage can be expanded to via Server Tokens.
  MAX_STORAGE_BOXES   = 100
  # Server Token cost to buy one additional Pokémon storage box.
  STORAGE_BOX_TOKEN_COST = 2
  ...
  USE_MULTIPLE_STAT_ITEMS_AT_ONCE      = true #(MECHANICS_GENERATION >= 8)
  ...
  # ID of the animation played when the player steps on grass at night (grass 
  # rustling).
  GRASS_NIGHT_ANIMATION_ID     = 2
  ...
  # Server Token cost for Kurt to finish your entire queued Ball order right now.
  KURT_INSTANT_TOKEN_COST = 5
  # The maximum amount of money the mom can have
...
#    ["Deutsch", "deutsch"]
  ...
  #-----------------------------------------------------------------------------
  # AI music toggle — set to false before uploading to sites that prohibit AI music.
  # Replaces the title screen BGM, InTheLight radio station, and the roamer
  # proximity Pokérap with "Added song".
  #-----------------------------------------------------------------------------
  USE_AI_MUSIC = true
  # Change for upload
