class Battle::Move
  ...
  def pbCalcDamageMultipliers(user, target, numTargets, type, baseDmg, multipliers)
    ...
    when :Electric
      ...
      multipliers[:power_multiplier] *= 1.5 if type != :ELECTRIC && user.affectedByTerrain? && @function_code == "IncreasePowerWhileElectricTerrain"
    when :Grassy
    ...
    when :Sun, :HarshSun
      ...
      when :WATER
        ...
        multipliers[:final_damage_multiplier] *= 1.5 if @function_code == "IncreasePowerInSunWeather"
      end
    when :Rain, :HeavyRain
      case type
      when :FIRE
