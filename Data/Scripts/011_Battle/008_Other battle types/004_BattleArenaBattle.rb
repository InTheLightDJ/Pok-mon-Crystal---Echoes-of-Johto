...
class Battle::Scene
  ...
  def updateJudgment(window, phase, battler1, battler2, ratings1, ratings2)
    ...
    colorShadow = Color.new(248, 248, 248)
    window.contents.clear
    pbSetSystemFont(window.contents)
    textpos = [
      [_INTL("Player's"), 62, 0, :center, Color.new(255, 0, 0), colorShadow],
      [_INTL("VS"), 140, 0, :center, colorBase, colorShadow],
      [_INTL("Rival's"), 226, 0, :center, colorBase, colorShadow],
      [_INTL("Mind"), 140, 24, :center, colorBase, colorShadow],
      [_INTL("Skill"), 140, 56, :center, colorBase, colorShadow],
      [_INTL("Body"), 140, 88, :center, colorBase, colorShadow],
      [total1.to_s, 56, 136, :center, colorBase, colorShadow],
      [_INTL("Judgment"), 140, 136, :center, colorBase, colorShadow],
      [total2.to_s, 234, 136, :center, colorBase, colorShadow]
    ]
    ...
    phase.times do |i|
      ...
      images.push(["Graphics/UI/Battle/judgment", 64 - 16, y, x, 0, 16, 16])
      x = (ratings1[i] == ratings2[i]) ? 64 : ((ratings1[i] < ratings2[i]) ? 0 : 32)
      images.push(["Graphics/UI/Battle/judgment", 240 - 16, y, x, 0, 16, 16])
    end
    pbDrawImagePositions(window.contents, images)
    window.contents.fill_rect(16, 126, 256, 4, Color.new(0, 0, 0))
  end
  ...
  def pbBattleArenaJudgment(battler1, battler2, ratings1, ratings2)
    ...
    begin
      ...
      dimmingvp.z = 99999
      infowindow = SpriteWindow_Base.new(0, 0, Graphics.width, 192)
