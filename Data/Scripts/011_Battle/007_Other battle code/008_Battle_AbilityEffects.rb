...
module Battle::AbilityEffects
  ...
  # Protean, Libero
  OnTypeChange                     = AbilityHandlerHash.new
  # Opportunist
  OnOpposingStatGain               = AbilityHandlerHash.new
  # Tera Shell (damage)
  ModifyTypeEffectiveness          = AbilityHandlerHash.new
  # Tera Shell (display)
  OnMoveSuccessCheck               = AbilityHandlerHash.new
  # Poison Puppeteer 
  OnInflictingStatus               = AbilityHandlerHash.new
...
Battle::AbilityEffects::AfterMoveUseFromTarget.add(:PICKPOCKET,
  proc { |ability, target, user, move, switched_battlers, battle|
    ...
    @battle.setSeenBattlerItem(user,target)
    user.item = nil
