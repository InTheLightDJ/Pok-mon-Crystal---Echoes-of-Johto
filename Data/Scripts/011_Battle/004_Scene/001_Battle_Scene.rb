...
class Battle::Scene
  ...
  MESSAGE_PAUSE_TIME   = 1.5   # In seconds
  # Text colors
  MESSAGE_BASE_COLOR   = Color.new(0, 0, 0)
  MESSAGE_SHADOW_COLOR = Color.new(248, 248, 248)
  ...
  FOE_BASE_X           = Settings::SCREEN_WIDTH - 80
  ...
  def pbEndBattle(_result)
    @abortable = false
    pbShowWindow(MESSAGE_BOX) # BLANK
