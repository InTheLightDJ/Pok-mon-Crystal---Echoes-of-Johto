...
def pbMessageDisplay(msgwindow, message, letterbyletter = true, commandProc = nil)
  ...
  textchunks = []
  controls = []
  while text[/(?:\\(f|ff|ts|cl|me|se|wt|wtnp|ch)\[([^\]]*)\]|\\(mg|g|cn|pt|wd|wm|op|cl|wu|\.|\||\!|\^))/i]
...
def pbShowCommands(msgwindow, commands = nil, cmdIfCancel = 0, defaultCmd = 0, max_width = Graphics.width)
