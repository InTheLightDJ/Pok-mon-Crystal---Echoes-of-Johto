...
class Color
  ...
  def self.red;     return Color.new(248,   0,   0); end
  def self.green;   return Color.new(  0, 128,   0); end
  def self.blue;    return Color.new(  0,   0, 248); end
  def self.yellow;  return Color.new(248, 248,   0); end
  def self.magenta; return Color.new(248,   0, 248); end
  def self.cyan;    return Color.new(  0, 248, 248); end
  def self.white;   return Color.new(248, 248, 248); end
  def self.gray;    return Color.new(128, 128, 128); end
  def self.black;   return Color.new(  0,   0,   0); end
  def self.pink;    return Color.new(248, 192, 203); end
  def self.orange;  return Color.new(248, 165,   0); end
  def self.purple;  return Color.new(128,   0, 128); end
  def self.brown;   return Color.new(165,  42,  42); end
  def self.gold;    return Color.new(248, 215,   0); end
  def self.silver;  return Color.new(192, 192, 192); end
  def self.crystal; return Color.new(167, 216, 222); end
  # Used specially when no shadowed text
  def self.nocolor; return Color.new(  0,   0,   0,   0); end
end
