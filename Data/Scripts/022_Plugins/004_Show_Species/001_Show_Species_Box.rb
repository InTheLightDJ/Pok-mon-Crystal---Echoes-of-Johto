...
class SpeciesIntro
  ...
  def show
    if @mark_as_seen
      Bridge.register_as_seen(@species, @gender, @shiny, @form)
    end
    bitmap = Bridge.pokemon_front_sprite_filename(
      @species, @gender, @shiny, @back, @form, @shadow
    )
  ...
  module Bridge
    ...
    def pokemon_front_sprite_filename(species, gender, shiny, back = false, form, shadow)
      return GameData::Species.front_sprite_filename(species, gender, shiny, back, form, shadow)
    end

    def register_as_seen(species, gender, shiny, form)
      $player.pokedex.register(species, gender, shiny, form)
    end
