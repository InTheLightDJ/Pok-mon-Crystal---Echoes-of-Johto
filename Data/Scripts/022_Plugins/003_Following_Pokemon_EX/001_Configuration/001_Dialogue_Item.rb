...
EventHandlers.add(:following_pkmn_item, :regular, proc { |_pkmn, _random_val|
  items = [
    ...
    :BLACKAPRICORN, :WHITEAPRICORN,:PURPLEAPRICORN, :HEARTSCALE, :EXPCANDYXS, :EXPCANDYS, 
    :EXPCANDYM, :EXPCANDYL, :EXPCANDYXL, :PLIPBALL, :CHERIBERRY, :CHESTOBERRY,
    :PECHABERRY, :RAWSTBERRY, :ASPEARBERRY, :LEPPABERRY, :ORANBERRY, :SITRUSBERRY, :PERSIMBERRY,
    :LUMBERRY, :LINKINGCORD, :HOPOBERRY
  ]
