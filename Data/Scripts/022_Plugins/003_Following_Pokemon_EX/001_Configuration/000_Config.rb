module FollowingPkmn
  ...
  ANIMATION_COME_OUT        = 13
  ANIMATION_COME_IN         = 14

  ANIMATION_EMOTE_HEART     = 8
  ANIMATION_EMOTE_MUSIC     = 9
  ANIMATION_EMOTE_HAPPY     = 9
  ANIMATION_EMOTE_ELIPSES   = 6
  ANIMATION_EMOTE_ANGRY     = 10
  ANIMATION_EMOTE_POISON    = 11
